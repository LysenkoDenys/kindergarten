...
const Button = (props) => {
  ...
  const themeBlock = darkTheme
    ? 'flex items-center justify-between ease-in-out duration-300 p-3 my-3 cursor-pointer bg-gray-700 hover:bg-gray-800 hover:text-white font-bold rounded-[15px] shadow-[3px_3px_2px_2px_rgba(255,255,255,0.8)] hover:shadow-[2px_2px_1px_1px_rgba(255,255,255,1)] text-[1em] text-center'
