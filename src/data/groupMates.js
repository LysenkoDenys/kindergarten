const groupMates = [
  ...
  },
  {
    ...
    story: [
      ...
      {
        text: 'Якось Сергій прийшов до садочку в джинсах, при чому, в дуже модних з кишенями біля колін на блискавках. Більшість з нас і мріяти не могли про таке в ті далекі часи. Мені теж собі такі захотілося, але я знав що то не здійсненна мрія. Мама Сергія працювала в «комісійному» магазині. Це давало свої бонуси.',
        img: '',
      },
      { text: '', img: '' },
    ],
  ...
  },
  {
    ...
    story: [
      {
        text: 'О - це моя сусідка по ліжку. Доречи, ніщо так не гартує колектив, як сумісний сон. Якось ми гралися на ліжках (уточнювати не буду як, але ідея гри була не погана для того віку), бо не хотілося спати і Олена необережно перенесла свою вагу на задню частину ліжка. От фанерне перекриття і перехилилося і вона ледь не з`їхала на підлогу.',
        img: '',
      },
      { text: '', img: '' },
      { text: '', img: '' },
  ...
  },
  {
    ...
    story: [
      {
        text: 'танцююча біля мене дівчика - допоможіть, будь ласка, розпізнати.',
        img: '',
      },
      { text: '', img: '' },
      { text: '', img: '' },
