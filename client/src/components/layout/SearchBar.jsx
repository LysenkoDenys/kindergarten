...
const SearchBar = ({ sendDataToParent }) => {
  ...
  const themeInput = darkTheme
    ? 'flex items-center p-3  bg-white rounded-[10px] w-[50%] mr-1 my-3 shadow-[2px_2px_2px_2px_rgba(255,255,255,0.8)] text-black'
    : 'flex items-center p-3 bg-white rounded-[10px] w-[50%] mr-1 my-3 shadow-[5px_5px_5px_5px_rgba(0,0,0,0.4)]';
