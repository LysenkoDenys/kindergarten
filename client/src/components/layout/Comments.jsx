...
const Comments = () => {
  ...
  const themeComment = darkTheme
    ? 'px-3 py-1.5 rounded-[10px] w-[50%] mr-2 my-3 shadow-[2px_2px_2px_2px_rgba(255,255,255,0.8)] text-black outline-none leading-[18px]'
    : 'px-3 py-1.5 rounded-[10px] w-[50%] mr-2 my-3 shadow-[5px_5px_5px_5px_rgba(0,0,0,0.4)] outline-none leading-[18px]';
