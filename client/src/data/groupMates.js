const groupMates = [
  ...
  },
  {
    ...
    story: [
      {
        text: 'Згідно свого прізвища – мав турецькі корені (кардаш з турецької -  друг), але був один з небагатьох, хто спілкувався українською мовою. Мав темперамент, як то кажуть, з вогником, тож коли грали у війну - дуже захоплювався, для нього це було важливо, тобто він звертав увагу на місцевість, на тактику бою, запекло сперечався з супротивником про умови, хто який рубіж буде захищати (майданчик “С”), хто увійде до складу підрозділу, воювалося з ним непогано. Воювали дрючками, галками, іграшкових пістолетів не було…',
        img: '',
      },
      {
  ...
  },
  {
    ...
    story: [
      {
        text: 'На майданчику “С” (це не сама старша в нас тоді група була) до мене підійшла одна дівчинка (як звати, не питайте – напишу тільки з її згоди). Каже: “Пойдем поцелуемся”. Ну я погодився, пішли ми за тіньовик подалі від всіх і поцілувались. По дитячому, без рук, але в губи… і… пішли гратися, вона до дівчат, я до хлопців… Ось такий в мене був перший поцілунок. Яскравий спогад. При чому, ми просто повторили те що казали про інших наших хлопців і дівчат, тобто, начебто хтось з дівочої елітної мікрогрупи вже цілувався з кимось з хлопчачої елітної мікрогрупи. Тобто, це був скоріше акт, типу “а що, ми гірше інших?”.',
        img: '',
      },
      {
        text: 'Прийшов в садочок і сів на паркан якось (майданчик “D”) один старший хлопець -  Гена (на той момент школяр) з найближчого будинку (Шевченка 35), друг Андрія Сирцова і Жовтяка Сергія. Питає в своїх друзів киваючи на мене: “а це хто?” Ну ті йому – це “Діса” (так мене називали). А він такий – почав з мене глузувати: “дісок – носок, колосок”. Мені було образливо… Але нічого, якось пережив, хоча це був перший раз, коли мене хтось обізвав і виставив в негативному світлі (я ж до цього моменту був “класний Діса” ага…). Потім Андрій мене підколював деякий час, що я - “Джулія Колосічкіна”. ',
        img: 'sitting.jpg',
      },
      {
