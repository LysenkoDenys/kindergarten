const groupMates = [
  ...
  },
  {
    ...
    story: [
      ...
      {
        text: 'Фото вище говорить за все замість тисячі слів. Ольга належала до елітної мікрогрупи і була її лідером. Мешкала на Жовтневій 4.',
        img: '',
      },
      { text: '', img: '' },
    ],
